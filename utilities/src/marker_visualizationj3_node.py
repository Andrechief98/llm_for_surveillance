...
class Node():
    ...
    def publishMarkerArrayCallback(self, data_json_string):
        ...
        for model_name in models_list:
            ...
            elif model_name == "door_2" or model_name == "door_3" or model_name == "door_4" or model_name == "door_5" or model_name == "door_6" or model_name == "door_7" or model_name == "door_8" or model_name == "door_9":
                self.msg_marker_text.pose.position.x = model_position_x+0.5
            else:
